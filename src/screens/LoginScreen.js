  ...
  return (
    <View style={{ position: 'absolute', left, top, transform: [{ scale }] }}>
      ...
      <View style={{
        ...
        borderRadius: 50, backgroundColor: accent, opacity: 0.18,
      }} />
      {/* Spine */}
      <View style={{
        position: 'absolute', top: 2, left: -5,
        width: 5, height: bh - 2,
        borderRadius: 2, backgroundColor: accent, opacity: 0.6,
      }} />
      {/* Cover */}
      <View style={{
        width: bw, height: bh, borderRadius: 6,
        borderWidth: 1, borderColor: accent,
        backgroundColor: '#0d0d1a', overflow: 'hidden',
      }}>
      ...
      <View style={{
        ...
        width: bw - 8, height: 6,
        borderRadius: 3, backgroundColor: 'rgba(0,0,0,0.4)',
      }} />
    </View>
  );
}
...
export default function LoginScreen({ navigation }) {
  ...
  return (
    ...
    >
      {/* ✅ FIX 1: Removed bounces & showsVerticalScrollIndicator — cause of the Boolean cast crash on Android */}
      <ScrollView style={styles.container}>
        ...
        <Animated.View style={[styles.form, { opacity: formOpacity, transform: [{ translateY: formAnim }] }]}>
          ...
          {/* ✅ FIX 2: disabled prop must be a real boolean, not a truthy value */}
          <TouchableOpacity
          ...
          {/* ✅ FIX 3: same boolean fix for googleLoading */}
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  // ✅ FIX 4: elevation only on Android to avoid style casting issues
  mainBtn: { backgroundColor: COLORS.primary, borderRadius: RADIUS.md, padding: 16, alignItems: 'center', marginBottom: 20, elevation: Platform.OS === 'android' ? 4 : 0 },
